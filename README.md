...
- **Handcrafted Feel:** Avoids the sterile look of generic templates, focusing on a bespoke, carefully curated aesthetic.
...
*   **[React](https://reactjs.org/)** - For building the interactive UI components.
*   **[Vite](https://vitejs.dev/)** - For ultra-fast development and optimized production builds.
*   **[Framer Motion](https://www.framer.com/motion/)** *(or custom CSS animations)* - For buttery-smooth, cinematic transitions.
*   **Vanilla CSS** - For precise, flexible, and deeply customized styling.
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/your-username/mothers-day-surprise.git
    ```
...
1.  **Update the Data:** Head over to `src/data/balloons.js` and replace the placeholder text/images with your own heartfelt messages and cherished family photos.
2.  **Tweak the Colors:** Modify `src/index.css` to match her favorite colors.
3.  **Add Your Voice:** Ensure every message in the polaroid modals sounds like it comes directly from you.
